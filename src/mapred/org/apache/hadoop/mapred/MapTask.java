    ...
    implements MapOutputCollector<K, V>, IndexedSortable {
        ...
        private String[] generateHash(Path finalOutputFile, SpillRecord spillRec) throws IOException {
            ...
            for(int part=0; part<spillRec.size(); part++) {
                ...
                if(codec != null) {
                    hashList[part] = Sha1Hash.convertHashToString(hashGen.generateHash(rfs, finalOutputFile, (int) index.startOffset, (int) index.partLength)).toString();
                } else {
                    hashList[part] = Sha1Hash.convertHashToString(hashGen.generateHash(rfs, finalOutputFile, (int) index.startOffset, (int) index.rawLength)).toString();
                }
            }
